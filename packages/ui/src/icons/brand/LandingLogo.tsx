...
export function LandingLogo({ currentStyle, ...props }: Props) {
    ...
    function getStyle() {
        ...
        return styles[currentStyle || Math.floor(Math.random() * styles.length)];
    }
