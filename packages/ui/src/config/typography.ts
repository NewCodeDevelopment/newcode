...
export const paragraphStyles = (size: ParagraphSizes, weight?: FontWeights) => {
    return {
        ...
        medium: classNames("text-md xl:text-xl 2xl:text-2xl", fontWeights(weight || "normal")),
        large: classNames("text-xl lg:text-2xl 2xl:text-3xl", fontWeights(weight || "normal")),
    }[size];
};
