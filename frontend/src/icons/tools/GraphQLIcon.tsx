...
export default function GraphQLIcon(props: FramerMotionSVGProps) {
  return (
    <motion.svg {...props} viewBox="0 0 29.999 30">
      <path stroke="none" d="M4.08 22.864l-1.1-.636L15.248.98l1.1.636z" />
      <path stroke="none" d="M2.727 20.53h24.538v1.272H2.727z" />
      <path
        stroke="none"
        d="M15.486 28.332L3.213 21.246l.636-1.1 12.273 7.086zm10.662-18.47L13.874 2.777l.636-1.1 12.273 7.086z"
      />
      <path stroke="none" d="M3.852 9.858l-.636-1.1L15.5 1.67l.636 1.1z" />
      <path
        stroke="none"
        d="M25.922 22.864l-12.27-21.25 1.1-.636 12.27 21.25zM3.7 7.914h1.272v14.172H3.7zm21.328 0H26.3v14.172h-1.272z"
      />
      <path stroke="none" d="M15.27 27.793l-.555-.962 10.675-6.163.555.962z" />
      <path
        stroke="none"
